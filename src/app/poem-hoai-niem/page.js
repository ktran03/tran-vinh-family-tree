...
<p style={{ fontSize: "2.5rem", lineHeight: "1.5" }}>
    ...
    圢制度不公<br />
            ...
            <h3>📜 Poem literal translation</h3>
            <pre>
1.	Ngư (魚) – Cá <br />
...
11. 	Hoài bão (懷抱) – Hoài bão, ước vọng, ôm ấp một ý chí lớn <br /><br />

12.	Ngũ (五) – Năm (số 5) <br />
13.	Tộc (族) – Dòng tộc, bộ tộc, gia tộc <br />
14.	Hướng (向) – Hướng đến, đi về phía <br />
15.	Công đồng (公同) – Lợi ích chung, đoàn kết vì cộng đồng <br /><br />
...
52.	Nghĩa (義) – Chính nghĩa, lẽ phải, đạo nghĩa <br /><br />

53.	Thanh bạch (清白) – Trong sạch, thanh khiết, liêm khiết <br />
54.	Nguyện (願) – Nguyện vọng, ước nguyện <br />
55.	Chung thân (終身) – Suốt đời, đến hết cuộc đời <br /><br />
...
60.	Bổn (本) – Gốc rễ, cốt lõi <br /><br />

61.	Giáo dục (教育) – Giáo dục, dạy dỗ <br />
62.	Từ (自) – Từ, kể từ <br />
63.	Sơ sinh (初生) – Mới sinh, tuổi nhỏ <br /><br />
...
86.	Biệt (別) – Chia ly, tách rời, phân biệt <br /><br />
...
91.	Thành (成) – Thành công, hoàn thành <br /><br />
...
100.	Công (公) – Công bằng, chính nghĩa, chung <br /><br />
            ...
            <h4>⚔️ Connection to a deeper History?</h4>
            <p>
                The mention of **“Ngũ Tộc”** (Five Clans) may hint at a larger social structure within 
                villages, where different family lineages cooperated for survival and prosperity.
            </p>
